    ...
    <head>
      <div style="height: 100px; width: 100%; background: linear-gradient( #8B8682, #8B8989); " id="particles-js"></div>
<script src="<?= Root('i/js/particles.js')?>"></script>
<script src="<?= Root('i/js/app.js')?>"></script>
...
-->
	...
	<section>
		...
		<ul class="nav nav-pills">
		  ...
		  <button type="button" class="btn btn-default btn-sm" id="Default"><span class="glyphicon glyphicon-fullscreen fa-fw"></span><span class="hidden-phone"> <?= L('default')?> <sub style="color:red">m</sub></span></button>
          <button type="button" class="btn btn-primary btn-sm" id="AddGraph"><span class="glyphicon glyphicon-plus fa-fw"></span><span class="hidden-phone"> <?= L('add_node')?> <sub style="color:red">v</sub></span></button>
		  <button type="button" class="btn btn-default btn-sm" id="ConnectGraphs"><span class="glyphicon glyphicon-road fa-fw"></span><span class="hidden-phone"> <?= L('connect_nodes')?> <sub style="color:#red">e</sub></span></button>
...
-->
        ...
        <button type="button" class="btn btn-default btn-sm" id="DeleteObject"><span class="glyphicon glyphicon-remove fa-fw"></span><span class="hidden-phone"> <?= L('delete')?> <sub style="color:red">r</sub></span></button>
